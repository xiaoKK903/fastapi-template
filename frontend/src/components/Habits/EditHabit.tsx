...
import { type HabitPublic, HabitsService } from "@/client"
...
const EditHabit = ({ habit, onSuccess }: EditHabitProps) => {
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="习惯名称" type="text" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
